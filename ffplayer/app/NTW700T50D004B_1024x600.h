...
{
    "NTW700T50D004B_1024x600", // const char *m_pPanelName;
    ...
    750, // MS_U16 m_wPanelMaxVTotal;       // 规格书 Max 750
    635, // MS_U16 m_wPanelVTotal;          // tv = 635
    635, // MS_U16 m_wPanelMinVTotal;       // 规格书 Min 624
    67,  // MS_U8 m_dwPanelMaxDCLK;
    51,  // MS_U8 m_dwPanelDCLK;            // 51.2 MHz
    41,  // MS_U8 m_dwPanelMinDCLK;         // 规格书 Min 40.8
    ...
    E_MI_PNL_CHG_HTOTAL,  //MHAL_DISP_ApiPnlOutTimingMode_e m_ucOutTimingMode;   ///<Define which panel output timing change mode is used to change VFreq for same panel
