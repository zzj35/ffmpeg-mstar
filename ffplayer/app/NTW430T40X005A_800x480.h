...
{
    "NTW430T40X005A_800x480", // const char *m_pPanelName;
    0, // MS_U8 m_bPanelDither :1;
    E_MI_PNL_LINK_TTL, // MHAL_DISP_ApiPnlLinkType_e m_ePanelLinkType   :4;

    // Board related setting
    1,  // MS_U8 m_bPanelDualPort  :1;
    0,  // MS_U8 m_bPanelSwapPort  :1;
    0,  // MS_U8 m_bPanelSwapOdd_ML    :1;
    0,  // MS_U8 m_bPanelSwapEven_ML   :1;
    1,  // MS_U8 m_bPanelSwapOdd_RB    :1;   // ✅ 红蓝交换（奇数）
    1,  // MS_U8 m_bPanelSwapEven_RB   :1;   // ✅ 红蓝交换（偶数）
    0,  // MS_U8 m_bPanelSwapLVDS_POL  :1;
    0,  // MS_U8 m_bPanelSwapLVDS_CH   :1;
    0,  // MS_U8 m_bPanelPDP10BIT      :1;
    1,  // MS_U8 m_bPanelLVDS_TI_MODE  :1;

    // For TTL Only
    0,  // MS_U8 m_ucPanelDCLKDelay;
    0,  // MS_U8 m_bPanelInvDCLK   :1;
    0,  // MS_U8 m_bPanelInvDE     :1;
    1,  // MS_U8 m_bPanelInvHSync  :1;   // 规格书 HS 负极性，反转
    1,  // MS_U8 m_bPanelInvVSync  :1;   // 规格书 VS 负极性，反转

    // Output driving current
    1,  // MS_U8 m_ucPanelDCKLCurrent;
    1,  // MS_U8 m_ucPanelDECurrent;
    1,  // MS_U8 m_ucPanelODDDataCurrent;
    1,  // MS_U8 m_ucPanelEvenDataCurrent;
    ...
    161, // MS_U16 m_wPanelHStart;          // HSyncWidth + HBP = 1+160
    24,  // MS_U16 m_wPanelVStart;          // VSyncWidth + VBP = 1+23
    800,// MS_U16 m_wPanelWidth;
    480, // MS_U16 m_wPanelHeight;

    1400,// MS_U16 m_wPanelMaxHTotal;
    1344,// MS_U16 m_wPanelHTotal;          // th = 1344
    1114,// MS_U16 m_wPanelMinHTotal;
    800, // MS_U16 m_wPanelMaxVTotal;
    635, // MS_U16 m_wPanelVTotal;          // tv = 635
    610, // MS_U16 m_wPanelMinVTotal;
    67,  // MS_U8 m_dwPanelMaxDCLK;
    51,  // MS_U8 m_dwPanelDCLK;            // 51.2 MHz
    40,  // MS_U8 m_dwPanelMinDCLK;

    25,  // MS_U16 m_wSpreadSpectrumStep;
    192, // MS_U16 m_wSpreadSpectrumSpan;
    ...
    0,   // MS_U8 m_bPanelSwapOdd_RG    :1;   // ❌ 关闭 RG 交换
    0,   // MS_U8 m_bPanelSwapEven_RG   :1;
    0,   // MS_U8 m_bPanelSwapOdd_GB    :1;   // ❌ 关闭 GB 交换
    0,   // MS_U8 m_bPanelSwapEven_GB   :1;

    1,   // MS_U8 m_bPanelDoubleClk     :1;
    0x001c848e, // MS_U32 m_dwPanelMaxSET;
    0x0018eb59, // MS_U32 m_dwPanelMinSET;
    E_MI_PNL_CHG_VTOTAL, // MHAL_DISP_ApiPnlOutTimingMode_e m_ucOutTimingMode;
